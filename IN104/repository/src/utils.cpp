...
// fonction sur la classe Sprite
// fonction permet de fixer les coordonnées d'origine / référence du Sprite sur le centre de celui ci
// par défaut, on dirige le sprite par le coordonnées en haut à gauche
...
// idem mais sur une autre classe
...
// idem mais en conservant les proportions
...
// de manière analogue à la fonction setOriginToCenter des Sprites, mais pour la classe text
